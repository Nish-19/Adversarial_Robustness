    ...
    def __init__(self,
        ...
        if self.train:
            if take_amount is not None:
                ...
                #implementing my own - Nischal
                take_amount = list(take_amount)
                #print(type(self.targets))#list
                self.targets = [self.targets[index] for index in take_amount]
                self.data = [self.data[index] for index in take_amount]
